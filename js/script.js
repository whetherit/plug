...
export const WEATHER_URL = "https://svtapp.ru/proxy/weather";
...
export function getWeatherTheme(code) {
  ...
  if ((code >= 51 && code <= 65) || (code >= 80 && code <= 82) || code >= 95) return "theme-rainy";
  if (code >= 71 && code <= 75) return "theme-snowy";
  return "weather";
}
